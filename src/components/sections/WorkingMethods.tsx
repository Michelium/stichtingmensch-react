    ...
    return (
        <section className="relative my-10 md:my-14" id='werkwijze'>
            ...
            <div className="container xl:px-32 py-12 md:py-20 relative z-10 flex flex-col justify-center items-center h-full text-center">
                ...
                <p className="text-base md:text-lg leading-8 text-slate-100/95">Wij zijn er voor het welbevinden van mensen. Wij willen dicht bij de mensen staan. Om hen een perspectief te geven op een zinvolle deelname aan het maatschappelijk leven. Wij zetten ons met
